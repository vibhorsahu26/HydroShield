...
function FloodPropagation() {
  return (
    <div className="rounded-[20px] border-2 border-sky-700/80 bg-sky-50/80 pb-4 shadow-[0_6px_0_rgba(25,64,83,0.12)]">
      ...
      <div className="grid grid-cols-4 gap-3 px-4 pb-1 pt-4">
        {timeSteps.map((label, index) => (
          <div key={label} className="flex flex-col items-center gap-2">
            <div className="relative h-25 w-full overflow-hidden rounded-xl border-2 border-sky-700/70 bg-linear-to-br from-emerald-200 to-green-300">
              <div className="absolute inset-0 bg-linear-to-r from-sky-300/70 to-sky-500/80 [clip-path:polygon(10%_60%,35%_54%,56%_62%,70%_50%,75%_25%,100%_18%,100%_100%,0_100%)]" />
              <div className={`absolute left-[44%] top-[33%] h-10 w-12 rotate-12 rounded-[50%_50%_55%_45%/58%_42%_58%_42%] border-2 border-sky-700/60 ${index === 0 ? 'bg-sky-300/70' : 'bg-sky-400/80'}`} />
            </div>
      ...
      <div className="relative mx-auto mt-4 h-4.5 w-[calc(100%-36px)]">
